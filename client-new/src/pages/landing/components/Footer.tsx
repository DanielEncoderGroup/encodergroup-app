...
/**
 * Componente Footer para la parte inferior de la Landing Page
 */
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            <img
              ...
              src="/assets/encoder-logo-white.svg"
              alt="EncoderGroup"
            />
            <p className="mt-4 text-base text-gray-300">
              Transformando ideas en soluciones tecnológicas innovadoras desde 2018.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="#methodology" className="text-base text-gray-300 hover:text-white">
                  Metodología
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#stack" className="text-base text-gray-300 hover:text-white">
                  Stack Tecnológico
                </a>
              </li>
              <li>
