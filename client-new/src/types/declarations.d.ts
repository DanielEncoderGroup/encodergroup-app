// Declaración de tipos para módulos sin tipos incluidos
declare module '@heroicons/react/24/outline' {
  ...
  export const ArrowLeftOnRectangleIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const ArrowRightIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const ArrowRightOnRectangleIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const ArrowUpTrayIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const Bars3Icon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const BarsArrowUpIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const ChartBarSquareIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const ClipboardDocumentListIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const ChatBubbleLeftEllipsisIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const ChatBubbleLeftIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const DocumentDuplicateIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const DotsVerticalIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const ExclamationCircleIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const InboxIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const PaperClipIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  ...
  export const PhotoIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  export const PlusCircleIcon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
...
declare module 'formik' {
  import { ComponentType, FormEvent, FormEventHandler, ReactNode } from 'react';
  
  export interface FormikErrors<Values> {
    [field: string]: string | string[] | FormikErrors<Values[keyof Values]> | undefined;
  }

  export interface FormikTouched<Values> {
    [field: string]: boolean | FormikTouched<Values[keyof Values]>;
  }
  ...
  export interface FormikHandlers {
    ...
    handleBlur: FormEventHandler<any>;
    handleChange: FormEventHandler<any>;
  }

  export type FormikProps<Values> = FormikState<Values> & FormikHelpers<Values> & FormikHandlers;
  ...
  export interface FormikBag<Props, Values> {
    props: Props;
    ...
    setTouched: (touched: FormikTouched<Values>) => void;
    setValues: (values: Values) => void;
    resetForm: (nextValues?: Partial<FormikState<Values>>) => void;
    setFieldValue: (field: string, value: any, shouldValidate?: boolean) => void;
  ...
  export function useFormik<Values>(config: FormikConfig<Values>): FormikProps<Values>;

  export function Formik<Values = any, ExtraProps = {}>(props: FormikConfig<Values> & ExtraProps): JSX.Element;
...
declare module 'yup' {
  ...
  export interface NumberSchema {
    ...
    oneOf(values: any[], message?: string): NumberSchema;
  }

  export interface BooleanSchema {
    required(message?: string): BooleanSchema;
    oneOf(values: any[], message?: string): BooleanSchema;
  }
  ...
  export interface DateSchema {
    ...
    oneOf(values: any[], message?: string): DateSchema;
  }
  ...
  export interface ObjectSchema {
    shape(shape: Record<string, any>): ObjectSchema;
    required(message?: string): ObjectSchema;
    noUnknown(allowUnknown?: boolean, message?: string): ObjectSchema;
  ...
  export function object(shape?: Record<string, any>): ObjectSchema;
  export function ref(path: string, options?: object): any;
}
